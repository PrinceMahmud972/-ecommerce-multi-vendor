            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('admin.section.update', ['section'=> $section->id]) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                      ...
                      <div class="form-group">
                        ...
                        <img class="img-fuild m-2" id="previewImage" src="{{ url('admin/images/section/'.$section->image) }}" style="height: 150px; height: 150px; object-fit:cover">
