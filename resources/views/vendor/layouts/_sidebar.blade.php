            ...
            <div class="nav">
                ...
                <div class="collapse" id="collapseShops" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                        <a class="nav-link" href="{{ route('vendor.shop.home') }}">Home</a>
                        ...
                        <div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordionPages">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="login.html">All Products</a>
                                <a class="nav-link" href="{{ route('vendor.product.create') }}">Create</a>
                ...
                <div class="collapse" id="collapseProfile" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="{{ route('vendor.editProfile') }}">Edit Profile</a>
                        <a class="nav-link" href="{{ route('vendor.changePassword') }}">Change Password</a>
                    </nav>
                </div>
