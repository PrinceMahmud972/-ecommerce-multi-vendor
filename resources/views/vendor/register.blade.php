                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('vendor.storeRegister') }}" method="post">
                                            @csrf
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="username" type="text" name="username" placeholder="johnDoe" />
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="mobile" type="text" name="mobile" placeholder="johnDoe" />
